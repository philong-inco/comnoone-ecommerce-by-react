...
const ProfileSection = () => {
  ...
  useEffect(() => {
    const fetchNhanVien = async () => {
      try {
        const response = await axios.get(`https://weblaptop-by-springboot-and-reactjs-ji0q.onrender.com/api/nhan_vien/${userInfo.id}`);
  ...
  const fetchVaiTro = async () => {
    try {
      const response = await axios.get(`https://weblaptop-by-springboot-and-reactjs-ji0q.onrender.com/api/vaitro/findbynhanvien/${userInfo.id}`);
