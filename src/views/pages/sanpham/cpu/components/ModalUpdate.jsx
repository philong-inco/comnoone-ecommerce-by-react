...
import { updateRam, IsValidAdd, IsValidUpdate } from 'api/sanpham/cpu';
  ...
  //Thông báo
    ...
    useEffect(() => {
        if(info && open){
            setRam({
                ten: info.ten,
                dongCPU: info.dongCPU,
            nhaSanXuat: info.nhaSanXuat,
                trangThai: 1
            })
        }
    }, [info, open])
