...
import { deleteRam, getRams } from 'api/sanpham/cpu';
...
const DanhSachCpu = () => {
  const columns = [
    ...
    { field: 'ten', headerName: 'Tên CPU', width: 130, flex: 1 },
    {
      field: 'dongCPU',
      headerName: 'Dòng CPU',
      flex: 1,
    },
    { field: 'nhaSanXuat', headerName: 'Nhà Sản Xuất', width: 130, flex: 1 },
    {
      field: 'actions',
      headerName: 'Thao Tác',
      sortable: false,
  ...
  return (
    <div>
      <MainCard title="Danh sách CPU / Chip">
