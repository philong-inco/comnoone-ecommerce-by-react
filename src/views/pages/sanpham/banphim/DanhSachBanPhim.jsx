...
import { deleteRam, getRams } from 'api/sanpham/banPhim';
...
const DanhSachBanPhim = () => {
  const columns = [
    ...
    { field: 'ten', headerName: 'Tên Bàn Phím', width: 130, flex: 1 },
    {
      field: 'actions',
      headerName: 'Thao Tác',
      sortable: false,
...
export default DanhSachBanPhim;
