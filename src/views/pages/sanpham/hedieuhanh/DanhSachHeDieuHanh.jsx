...
import { deleteRam, getRams } from 'api/sanpham/heDieuHanh';
...
const DanhSachHeDieuHanh = () => {
  const columns = [
    ...
    { field: 'ten', headerName: 'Tên Hệ Điều Hành', width: 130, flex: 1 },
    {
      field: 'actions',
      headerName: 'Thao Tác',
      sortable: false,
  ...
  return (
    <div>
      <MainCard title="Danh sách Hệ Điều Hành">
...
export default DanhSachHeDieuHanh;
