...
import { deleteRam, getRams } from 'api/sanpham/webcam';
...
const DanhSachWebcam = () => {
  const columns = [
    ...
    { field: 'ten', headerName: 'Tên Webcam', width: 130, flex: 1 },
    {
      field: 'doPhanGiai',
  ...
  return (
    <div>
      <MainCard title="Danh sách Webcam">
