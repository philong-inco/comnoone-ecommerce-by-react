...
import { deleteRam, getRams, filterRam, updateRam } from 'api/sanpham/mauSac';
...
const suaTrangThai = async (id, status) => {
  try{
    let tempData = await axios.get(`${backEndUrl}/mau-sac/detail/${id}`);
