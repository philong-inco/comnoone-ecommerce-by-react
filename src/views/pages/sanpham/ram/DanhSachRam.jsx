...
import { deleteRam, getRams, filterRam, updateRam } from 'api/sanpham/ram';
...
const DanhSachRam = () => {
  const columns = [
    ...
    { id: 'dungLuong', label: 'Dung lượng', minWidth: 120 },
    { id: 'tocDoBus', label: 'Tốc độ bus', minWidth: 120 },
...
const suaTrangThai = async (id, status) => {
  let tempData = await axios.get(`${backEndUrl}/ram/detail/${id}`);
