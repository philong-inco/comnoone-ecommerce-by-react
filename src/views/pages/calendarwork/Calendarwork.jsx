...
function Calendarwork() {
  ...
  const findNhanVien = async (id) => {
    const result = await axios.get(`https://weblaptop-by-springboot-and-reactjs-aqjc.onrender.com/api/nhan_vien/${id}`);
    return result.data.ten;
  }

  const findCaLamViec = async (id) => {
    const result = await axios.get(`https://weblaptop-by-springboot-and-reactjs-aqjc.onrender.com/api/ca_lam_viec/searchcalamviec/${id}`);
  ...
  const fetchAllLichLamViec = async () => {
    try {
      ...
      debugger;
      const response = await axios.get('https://weblaptop-by-springboot-and-reactjs-aqjc.onrender.com/api/lichlamviec/danhsachlich');
  ...
  const fetchAllNhanVien = async () => {
    try {
      const result = await axios.get('https://weblaptop-by-springboot-and-reactjs-aqjc.onrender.com/api/nhan_vien/danhsachnhanvien');
  ...
  const fetchAllCaLamViec = async () => {
    try {
      const results = await axios.get('https://weblaptop-by-springboot-and-reactjs-aqjc.onrender.com/api/ca_lam_viec/danhsach');
  ...
  const handleSaveEvent = async () => {
    if (chuThich && idNhanVien && idCaLamViec && selectedDate) {
      try {
        ...
        await axios.post('https://weblaptop-by-springboot-and-reactjs-aqjc.onrender.com/api/lichlamviec/addlichnhanvien', {
          chuThich,
          idNhanVien,
          idCaLamViec,
