  ...
  const handleConfirmClose = async (isConfirmed) => {
    ...
    if (isConfirmed && formData) {
      ...
      try {
        ...
        const response = await axios.post(`https://weblaptop-by-springboot-and-reactjs-ji0q.onrender.com/api/khachhang/create`, finalData, {
  ...
  return (
    <LocalizationProvider dateAdapter={AdapterMoment}>
      ...
      <Dialog open={confirmDialogOpen} onClose={() => handleConfirmClose(false)}>
        ...
        <DialogContent>
          <DialogContentText>Bạn có chắc chắn muốn lưu thông tin này không?</DialogContentText>
        </DialogContent>
        <DialogActions>
