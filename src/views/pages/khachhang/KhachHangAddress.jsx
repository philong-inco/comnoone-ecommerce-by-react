...
function KhachHangAddress() {
  ...
  const handleConfirmSetDefault = async () => {
    ...
    if (selectedAddress) {
      try {
        setLoading1(true);
        await axios.put(`https://weblaptop-by-springboot-and-reactjs-ji0q.onrender.com/api/diachi/defaultlocation/${selectedAddress.id}?idKhachHang=${id}`, null);
  ...
  const handleConfirmUnsetDefault = async () => {
    ...
    if (selectedAddress) {
      try {
        setLoading2(true);
        await axios.put(`https://weblaptop-by-springboot-and-reactjs-ji0q.onrender.com/api/diachi/undefaultlocation/${selectedAddress.id}?idKhachHang=${id}`, null);
  ...
  const handleDeleteAddress = async () => {
    try {
      setLoading3(true);
      await axios.delete(`https://weblaptop-by-springboot-and-reactjs-ji0q.onrender.com/api/diachi/${addressId}`);
    } catch (error) {
  ...
  const fetchKhachHangInfo = async (id) => {
    try {
      const response = await axios.get(`https://weblaptop-by-springboot-and-reactjs-ji0q.onrender.com/api/khachhang/searchbyid/${id}`);
      ...
      const responseDiaChi = await axios.get(`https://weblaptop-by-springboot-and-reactjs-ji0q.onrender.com/api/diachi/getAllDiaChiByIdKhachHang/${id}`);
  ...
  const onSubmit = async (data) => {
    try {
      ...
      const url = `https://weblaptop-by-springboot-and-reactjs-ji0q.onrender.com/api/khachhang/update/${id}`;
  ...
  const onAddressSubmit = async (data) => {
    try {
      ...
      try {
        const url = data.id_dia_chi ? `https://weblaptop-by-springboot-and-reactjs-ji0q.onrender.com/api/diachi/updatelocation/${data.id_dia_chi}` : 'https://weblaptop-by-springboot-and-reactjs-ji0q.onrender.com/api/diachi/create';
